                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <form onSubmit={onSubmitForm}>
                                    ...
                                    <input className="inputs form-control" type="email" style={{ border: '1px solid #270d44', borderRadius: '10px' }} placeholder="Enter your Emailid" id="email" onChange={(e) => setemail1(e.target.value)} /><br />
...
export default RecruitersLoginPage;
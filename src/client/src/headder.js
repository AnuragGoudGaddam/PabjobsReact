                    ...
                    <nav class="navbar navbar-expand-sm ">
                        <div class="container-fluid " id="navBar">
                            ...
                            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                                ...
                                <div style={{ marginLeft: "30px" }} >
                                    <ul className="navbar-nav" style={{ fontWeight: "400", color: "#270d44" }}>
                                        <li className="nav-item">
                                            <a className="nav-link" href="browsejobs" style={{ fontWeight: "bold " }}>Browse Jobs  <i class="fa-solid fa-caret-down"></i> </a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div style={{ marginLeft: "30px" }}>
                                    <ul className="navbar-nav" style={{ fontWeight: "500", color: "#270d44" }}>
                                        <li className="nav-item">
                                            <a className="nav-link" href="jobmain" style={{ fontWeight: "bold " }}>Jobs <i class="fa-solid fa-caret-down"></i></a>
                                        </li>
                                    </ul>
                                </div>

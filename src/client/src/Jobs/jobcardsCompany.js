...
const JobsByCompany = () => {
    ...
    const filterData = () => {
        const filterBlogs = expdata.filter((job) => {
            return job?.companyname && job.companyname.some((eachData) =>
            ...
            <div className="container buttoncontainer  mt-5">
                <div class="row  ">
                    ...
                    <div class="col-md-2" id="JobsByCompany">
                        <a href="jobbycompany">  <button type="button" style={{ backgroundColor: '#270d44', color: '#ffff', fontSize: 'x-small', border: '1px solid black' }}
                    ...
                    <div className='row'>
                        ...
                        {search &&
                            <div className='col-md-2' ref={el => elementRefs[expdata.buttonName] = el}>
                                <p className='para616'>{search.recruiter.companyname}
                            ...
                            {expfilter.map((blog) => (
                                <div key={blog._id} onClick={(e)=> onClickbut(blog._id )} className="" >
                                    <div className="mt-5">
                                        <div className="">
                                            <div className="">
                                                <button className="btn  " style={{ border: '1px solid black', width: '280px' }}>{blog.recruiter.companyname}</button>
                                            </div>

...
const Home = () => {
    return (
        <div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 ">
                        <div class="row">
                            <div class="col-4"> </div>
                            <div class="col-5">
                                <p style={{color:'#270d44' ,fontWeight:'bold'}}> <h5>Find your dream job here</h5></p>
                                <p>5 lack + plus jobs for you to explore</p>
                            </div>
                            <div class="col-4"> </div>
                        </div>
                        <div class="input-group mb-3 p-2">

                            <div class="col-md-2 col-12 d-flex flex-row form-control m-2"
                                style={{ backgroundColor: "white", height: "40px", width: "80px", borderRadius: "10px" }} >
                                ...
                                <span className="px-5 mt-1 "><input class="w-100 dropdown-toggle  "
                                    style={{ border: "none", fontSize: "small", width: " 350px"  }} type="text"
            ...
            <div className="container mb-1">
                <div className="row">
                    ...
                    <div className="col-md-9 col-12">
                        <p style={{ color: "#270d44", fontWeight: 'bold' }}>Top Searches</p>
            ...
            <div class=" container " id="pabJobsON" style={{ backgroundColor: "#f8f2f8" }}>
                <div class="row ">
                    <div class="col-2 "></div>
                    <div class=" col-4 px-3">
                        <p style={{ color: "#270d44", fontWeight: 'bold' }}>Search By Location</p>
                    </div>
                    <div class=" col-md-8 d-flex flex-row ">
                        ...
                        <div class="col-md-1 m-1  " style={{ width: '150px', borderRadius: '10px' }}>
                            <button className="btn form-control shadow w-100 " style={{ height: "50px", fontSize: "small", justifyContent: "space-evenly", color: "#270d44", backgroundColor: "white" }}><img

                                src="https://www.shutterstock.com/shutterstock/photos/1132432067/display_1500/stock-vector-charminar-hyderabad-illustration-or-sketch-1132432067.jpg"
                                width="35px" height="40px" alt="" />Hyderabad</button>
                        </div>
                        <div class="col-md-1 m-1 " style={{ width: '150px' }}>
                            <button className="btn form-control shadow w-100 " style={{ height: "50px", fontSize: "small", justifyContent: "space-evenly", color: "#270d44", backgroundColor: "white" }}><img

                                src="https://static.thenounproject.com/png/591250-200.png"
                                width="35px" height="40px" alt="" />Mumbai</button>
                        </div>

                        <div class="col-md-1 m-1 " style={{ width: '150px' }}>
                            <button className="btn form-control shadow w-100 " style={{ height: "50px", fontSize: "small", justifyContent: "space-evenly", color: "#270d44", backgroundColor: "white" }}><img

                                src="https://cdn.iconscout.com/icon/free/png-256/free-chennai-119687.png"
                                width="35px" height="40px" alt="" />Chennai</button>
                        </div>
                        ...
                        <div class="col-md-1 m-1 " style={{ width: '150px' }}>
                            <button className="btn form-control shadow w-100 " style={{ height: "50px", fontSize: "small", justifyContent: "space-evenly", color: "#270d44", backgroundColor: "white" }}><img
                                ...
                                width="35px" height="40px" alt="" />Pune</button>
                        </div>

                        <div class="col-md-1 m-1 " style={{ width: '150px' }}>
                            <button className="btn form-control shadow w-100 " style={{ height: "50px", fontSize: "small", justifyContent: "space-evenly", color: "#270d44", backgroundColor: "white" }}><img

                                src="https://static.thenounproject.com/png/2165510-200.png"
                                width="35px" height="40px" alt="" />Banglore</button>
                        </div>

                        <div class="col-md-1 m-1 px-2" style={{ width: '150px' }}>
                            <button className="btn form-control shadow w-100 " style={{ height: "50px", fontSize: "small", justifyContent: "space-evenly", color: "#270d44", backgroundColor: "white" }}><img

                                src="https://cdn2.vectorstock.com/i/1000x1000/65/91/india-gate-new-delhi-icon-simple-style-vector-7776591.jpg"
                                width="35px" height="40px" alt="" />Delhi</button>
                        </div>
            ...
            <div class="container p-2 mt-1">
                <div class="row">
                    <div class="col-2 "></div>
                    <div class=" col-4 ">
                        <p style={{ color: "#270d44", fontWeight: 'bold' }}>Top Companies By Catogery</p>
                    </div>
                    ...
                    <div className=" col-md-9 row">
                        ...
                        <div class="col-6 col-md-3 card1 shadow ">

                            <p style={{ fontSize: "small" }}>MNC's </p>
                        ...
                        <div className="col-6 col-md-3 card1 shadow  ">
                            <p style={{ fontSize: "small" }}>Banking & finance  </p>
                            <p style={{ color: "#270d44", fontSize: "xx-small" }}>1.5k jobs are avilable</p>
                            <div class="row ">
                                <div className="col-3">
                        ...
                        <div class="col-6 col-md-3 card1 shadow ">
                            ...
                            <p style={{ fontSize: "small" }}>FMCG & RETAIL  </p>
                            <p style={{ color: "#270d44", fontSize: "xx-small" }}>1.5k jobs are avilable</p>
                            <div class="row m-2">
                                <div class="col-3">
                        ...
                        <div class="col-6 col-md-3 card1 shadow ">
                            ...
                            <p style={{ fontSize: "small" }}>Health care </p>
                            <p style={{ color: "#270d44", fontSize: "xx-small" }}>1.5k jobs are avilable</p>
                            <div class="row">
                                <div class="col-4">
            ...
            <div class="container mt-3 ">
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-9" style={{ backgroundColor: "#270d44", color: "#ffff", fontSize: "x-small" }}>
                        <div class="row">
                            <div class="col-4">
            ...
            <div class="container  col-12 mt-3 mb-3  " style={{ backgroundColor: " #f8f2f8" }}>
                <div className="row ">
                ...
                <div className="col-2"></div>
                    ...
                    <div class=" col-4 ">
                        ...
                        <div className="row">
                            ...
                            <div class="col-md-2 mt-2 ">
                                <button class="form-control btn" style={{ color: "#270d44", backgroundColor: " #ffff", fontize: "xx-small" }}>Hr
                                    Executive</button>
                            </div>
            ...
            <div class="container mt-3 ">
                <div class="row">
                    <div class="col-2 "></div>
                    <div class="col-9  " style={{ color: "#ffff", backgroundColor: " #270d44", fontize: "x-small" }}>
                        <div class="row">
                            <div class="col-4">
               ...
               <div className="col-2"></div>
            <div class="container  col-md-8 col-12 mt-3 mb-3 " style={{ backgroundColor: " #270d44", marginLeft:'270px', borderRadius:'14px' }}>
                <div class="row">
                    <div >
